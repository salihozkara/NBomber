...
type SchedulerExec = RunningScenarioContext -> ScenarioActor list -> int -> ScenarioActor list
...
let exec (scnCtx: RunningScenarioContext) (actorPool: ScenarioActor list) (scheduledActorCount: int) =
...
type ConstantActorScheduler(scnCtx: RunningScenarioContext, exec: SchedulerExec) =
